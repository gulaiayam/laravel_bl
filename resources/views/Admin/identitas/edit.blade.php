...
<div class="page-content">
         <div class="container-fluid">
           ...
           <form class="card" method="POST" action="{{route('identitas.update', ['identita' => $identita])}}">
                    @csrf
                    @method('PUT')
                                        <div class="card">
                    <div class="card-body row g-3">
                    <h5 id="pages_title">Ubah identitas</h5>
                        ...
                        <div class="tab-content" id="borderTopContent">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" placeholder="Nama" id="input-placeholder" name="jenis_identitas" value="{{ $identita->jenis_identitas ?? old('jenis_identitas') }}">
                            </div>
                        </div>
                                </div>  
                            </div>
