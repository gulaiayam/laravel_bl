...
<div class="page-content">
         <div class="container-fluid">
           ...
           <form class="card" method="POST" action="{{route('universitas.update', ['universita' => $universita])}}">
                    @csrf
                    @method('PUT')
                                        <div class="card">
                    <div class="card-body row g-3">
                    <h5 id="pages_title">Ubah Universitas</h5>
                        ...
                        <div class="tab-content" id="borderTopContent">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" placeholder="Nama" id="input-placeholder" name="nama" value="{{ $universita->nama ?? old('nama') }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="input-placeholder">Alamat</label>
                                <textarea name="alamat" id="alamat" class="form-control">{{ $universita->alamat ?? old('alamat') }}</textarea>
